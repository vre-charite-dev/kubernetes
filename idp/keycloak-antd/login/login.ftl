...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=(realm.password && social.providers??); section>
    <#if section = "header">
        <#--  ${msg("doLogIn")}  -->
        <img style="float:left" src="${url.resourcesPath}/img/VRE-logo.png"></img>
    <#elseif section = "form">
                    ...
                    <div id="kc-form-options">
                        ...
                        <div class="${properties.kcFormOptionsWrapperClass!} forget-password">
                            <#if realm.resetPasswordAllowed>
                                <span><a tabindex="5" target="_blank" href="https://zugang.charite.de">${msg("doForgotPassword")}</a></span>
                            </#if>
                        </div>
